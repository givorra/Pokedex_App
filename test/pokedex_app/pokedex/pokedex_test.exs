defmodule PokedexApp.PokedexTest do
  ...
  describe "pokemons" do
    ...
    @valid_attrs %{description: "some description", evolution_to: "some evolution_to", favourite: true, name: "some name", tipe1: "some tipe1", tipe2: "some tipe2"}
    ...
    test "create_pokemon/1 with valid data creates a pokemon" do
      ...
      assert pokemon.tipe1 == "some tipe1"
      assert pokemon.tipe2 == "some tipe2"
    end
    ...
    test "update_pokemon/2 with valid data updates the pokemon" do
      ...
      assert pokemon.tipe1 == "some updated tipe1"
      assert pokemon.tipe2 == "some updated tipe2"
    end
